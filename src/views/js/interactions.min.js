...
function intbutton(value1, value2) {
    return `<div id="int" class="col-md-12"><span class="btn btn-lg btn-warning btn-block int" id="${value1}">${value2}</span></div>`;
}

function execute(id) {
    fetch(`http://127.0.0.1:3000/api/interaccion/${id}`);
    changeview('vieweyes');
}